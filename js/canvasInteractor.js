...
const canvasInteractor = {
    ...
    prototype: {
        ...
        handleEvent(e) {
            if (e.type in this && (e.isPrimary || e.type === 'wheel')) {  // can I handle events of type e.type .. ?
                const bbox = e.target.getBoundingClientRect && e.target.getBoundingClientRect() || {left:0, top:0},
                      ...
                      x = e.target.nodeName === 'CANVAS' ? e.clientX - Math.floor(bbox.left) : e.clientX,
                      y = e.target.nodeName === 'CANVAS' ? e.clientY - Math.floor(bbox.top) : e.clientY;
                ...
                //client coordinates
                this.evt.xiClient = this.evt.xClient;
                this.evt.yiClient = this.evt.yClient;
                this.evt.xClient = e.clientX;
                this.evt.yClient = e.clientY;
                this.evt.dxClient = this.evt.dyClient = 0;
        ...
        pointermove() {
            ...
            this.evt.dxClient = this.evt.xClient - this.evt.xiClient;
            this.evt.dyClient = this.evt.yClient - this.evt.yiClient;
